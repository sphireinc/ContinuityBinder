...
export const resources = {
    en: { common: enCommon, landing: enLanding, navigation: enNavigation, sections: enSections },
    es: { common: esCommon, landing: esLanding, navigation: esNavigation, sections: esSections },
};
